        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditEntries_ProcurementRequests_ProcurementRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_ProcurementRequests_ProcurementRequestId",
                        column: x => x.ProcurementRequestId,
                        principalTable: "ProcurementRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LineItems_ProcurementRequests_ProcurementRequestId",
                        column: x => x.ProcurementRequestId,
                        principalTable: "ProcurementRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditEntries_ProcurementRequestId",
                table: "AuditEntries",
                column: "ProcurementRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_ProcurementRequestId",
                table: "Comments",
                column: "ProcurementRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_LineItems_ProcurementRequestId",
                table: "LineItems",
                column: "ProcurementRequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProcurementRequests_Department",
                table: "ProcurementRequests",
                column: "Department");

            migrationBuilder.CreateIndex(
                name: "IX_ProcurementRequests_RequesterId",
                table: "ProcurementRequests",
                column: "RequesterId");
